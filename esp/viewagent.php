			...
			<div class="card-body">
				...
				<div class="row">
					...
					<div class="col-md-9">
						...
						<div class="list-group">
  							<a href="viewagent.php" class="list-group-item list-group-item-action bg-dark text-light">View All Agents</a>
  						</div>

  						&nbsp;&nbsp;&nbsp;

  						<div class="list-group">
  							<a href="status.php" class="list-group-item list-group-item-action">Block/Unblock Agent</a>
  						</div>
						...
						<table class="table table-striped table-sm text-center">
							...
							if ($num>0) {
								...
								<tr>
									...
									<td>
										<a onclick="return confirm('Are you sure you want to delete this ?')" href="deleteagent.php?Id=<?php echo $data['Id'] ?>"><i class="fas fa-trash text-danger"></i></a>
										&nbsp;
										<a onclick="return confirm('Continue?')" href="updateagent.php?Id=<?php echo $data['Id'] ?>"><i class="fas fa-edit"></i></a>
									</td>
								</tr>
							...
							<?php
								...
								echo "<center><span class='badge badge-success p-3 mb-2'>There is No Agent &nbsp;&nbsp;<i class='fas fa-bars'></i></span></center>";
							}
